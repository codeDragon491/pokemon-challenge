...
export default {
  ...
  setup() {
    ...
    const tabs = ref([ {name:'charmander', imageSrc: require('@/assets/images/charmander.jpg')} , {name:'pikachu', imageSrc: require('@/assets/images/pikachu.jpg')}, 
    ...
    return { tabs, pokemon, loading, error, getTabItem, activeTab, pokemonAbilities}
  }
}
</script>
